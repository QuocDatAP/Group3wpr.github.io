...
Tags: Elementor, WooCommerce, Elementor WooCommerce Builder, WooCommerce Builder,  WooCommerce Product, WooCommerce Elementor, Woo Product, WooCommerce Template, Woo builder, WooCommerce Gutenberg Blocks, WooCommerce Shop Builder, WooCommerce Carousel Slider
...
Elementor WooCommerce Builder, Shop Page, Product Page, Quick View, Wishlist, Products Compare, Filter, Carousel Slider, Suggest Price Woo Builder.

== Description ==

Are you using multiple plugins to make an Elementor-compatible WooCommerce store with custom product templates, cart, wishlist, product comparison, sliders, quick view, and variation swatches?

Well, not anymore! You don’t have to slow down your eCommerce website. 

Introducing **[ShopEngine](https://wpmet.com/plugin/shopengine)** - all-in-one WooCommerce builder for Elementor and Gutenberg! 
...
With ShopEngine WooCommerce plugin, you can joy all the functionalities of a full-fledged online shop with custom WooCommerce product template builder. 

Also, this shop template builder works with free Elementor page builder and WooCommerceopen-source eCommerce solution.

You can utilize ShopEngine's **70+ drag-and-drop Elementor widgets and 20+ WooCommerce modules, 16+ ready woo shop builder** templates without affecting loading speed. 

You can also drag and drop this WooCommerce template builder like Elementor to customize all these widgets, modules and Elementor WooCommerce templates.

In addition, you can utilize both the custom WooCommerce product template builder as well as the Gutenberg WooCommerce blocks of ShopEngine.

Overall, ShopEngine Elementor WooCommerce template builder addon facilitates WooCommerce product designers to a great extent. So, ShopEngine is the most complete and dynamic WooCommerce template builder for Elementor.
...
## 👉 ShopEngine Elementor WooCommerce Shop Builder Includes:

⭐ Complete **WooCommerce solution for Elementor**
**⭐ 70+ WooCommerce shop builder widgets**
**⭐ 20+ Essential** WooCommerce Modules
**⭐ 16+ pre-designed** WooCommerce shop builder templates
**⭐ Override WooCommerce pages** like woo shop page, single page, order page, cart page, my account page, checkout page, Thank you page, etc
...
👉 Related WooCommerce Products Widget
👉 View Single WooCommerce Product Widget
...
👉 Archive WooCommerce Description Widget 
👉 Archive WooCommerce Products Widget
...
👉 Deal WooCommerce Products Widget
👉 Filterable WooCommerce Product List Widget
👉 WooCommerce Product Category List Widget
👉 Recently Viewed WooCommerce Products Widget
...
Using these effective features of ShopEngine WooCommerce product's quick view module, your customers can do shopping in the shortest possible time. 
...
As an e-commerce website owner, you should make sure that you’ve added a functional WooCommerce Product Wishlist button with every product.

Leveraging this WooCommerce Product Wishlist module of the ShopEngine, shoppers can save any products for buying in the future. When they come back to your website later adding products to the Woo wishlist, they can easily track the products on the list and add them to the cart for buying.
...
**Quick checkout module** provides your customers with a quick checkout option that will save your customers time.

ShopEngine WooCommerce template builder offers a quick checkout option for your eCommerce store that redirects to the Shopify style checkout page. 

You can add a single product cart button to the product with this module which will redirect your customers to the checkout page.
...
Moreover, a 100% customization option is also open for every property of this sales countdown WooCommerce module that can make your offers on special days more attractive.
...
The **additional checkout field module** of ShopEngine Elementor WooCommerce shop builder add-on will let you add new fields to your checkout form and remove it when it has no use. 
...
This Multistep Shopify-like Checkout of this drag-and-drop Elementor WooCommerce store builder add-on will increase your customers’ satisfaction by letting them fill out the form in a convenient way.
...
-   **[Product Price](https://wpmet.com/doc/product-price/):**  Customize the color, typography with unlimited color and font variations of WooCommerce product price, and align with the suggested product price tag with this drag and drop Elementor widget.
...
-   **[Add to Cart](https://wpmet.com/doc/add-to-cart/):** Change the colors, layout, style, hover effect, and place the single product cart button in any position you want. Build the finest single product cart button with this widget.
...
-   **[Product Images](https://wpmet.com/doc/product-image/):** Find the right icon for the product lightbox. Make changes to the color, and typography with unlimited color and font variations, image position, zoom control, border type, border radius, etc. from the sale flash, lightbox zoom icon, and image style settings. 
...
-   **[Product Share](https://wpmet.com/doc/product-share/):** Display the product share widget to your customers in a lively manner. As a result, your customers can share products on their social media like Facebook, Instagram, LinkedIn, Twitter, etc, easily.
...
v2.2.2 // 18-04-2022
Added: Range WooCommerce carousel slider layout support for Module settings.
...
Fixed: WooCommerce product template library import issue with Unicode Specifically Arabic text.
...
Added: WooCommerce Category Carousel widget dropdown color and background color control for advanced WooCommerce AJAX Search Widget.
...
Fixed: Loop issue for WooCommerce elementor panel issue
...
v1.2.0 // 22-09-2021
Added: All style added from WooCommerce Elementor control for 'Currency Switcher' Widget.
Added: Dashboard Module Settings page
...
Fixed: Product image widget visual issue.
Fixed: unwanted breadcrumb in the WooCommerce Shop Page Builder and archive page with pagination
Fixed: Some php notices in WooCommerce elementor editor is resolved
...
**Prerequisite:** ShopEngine works with [Elementor](https://wordpress.org/plugins/elementor/) and [WooCommerce](https://wordpress.org/plugins/woocommerce/). Make sure you have installed Elementor and WooCommerce plugins.
