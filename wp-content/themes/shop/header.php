...
<head>
  ...
  <link rel="apple-touch-icon" href="<?php echo get_theme_file_uri('/images/apple-touch-icon.html') ?>">
  <link rel="apple-touch-icon" sizes="72x72" href="<?php echo get_theme_file_uri('/images/apple-touch-icon-72x72.html')?>">
  <link rel="apple-touch-icon" sizes="114x114" href=" <?php echo get_theme_file_uri('/images/apple-touch-icon-114x114.html') ?>">
    <?php wp_head() ?>
</head>
    ...
    <div class="nl-popup-inner">
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="newsletter-inner"> <img src="<?php echo get_theme_file_uri('/images/plane.png') ?>" alt=" ">
    ...
    <div class="header-middle">
      ...
      <div class="header-inner">
        <div class="navbar-header">
          ...
          <a class="navbar-brand page-scroll" href="index.html"> <img alt=" " src="<?php echo get_theme_file_uri('/images/logo.png') ?>"> </a> </div>
                  ...
                  <div class="cart-dropdown header-link-dropdown">
                    <ul class="cart-list link-dropdown-list">
                      <li> <a class="close-cart"><i class="fa fa-times-circle"></i></a>
                        <div class="media"> <a class="pull-left"> <img alt=" " src="<?php echo get_theme_file_uri('/images/products/item-small-1.jpg') ?>"></a>
                      ...
                      <li> <a class="close-cart"><i class="fa fa-times-circle"></i></a>
                        <div class="media"> <a class="pull-left"> <img alt=" " src="<?php echo get_theme_file_uri('/images/products/item-small-2.jpg"') ?>></a>
                          <div class="media-body"> <span><a>Summer Women Nice Cloth</a></span>
                            <p class="cart-price">$29.99</p>
                          </div>
                        </div>
      ...
      <div class="row m-0">
        <div class="col-md-3 position-i p-0">
            <div class="sidebar-menu-dropdown home ptb-20">
              ...
              <div id="cat" class="cat-dropdown" style=" <?php if(!is_home() || !is_front_page()) echo 'display: none';  ?>">
                            ...
                            <div class="megamenu-inner-top">
                              <ul class="sub-menu-level1">
                                ...
                                <li class="level2 hidden-xs hidden-sm">
                                  <a href="shop.html">
                                    <img src="<?php echo get_theme_file_uri('images/banner/menu-banner.jpg') ?>" alt="Xpent ">
                                  </a>
                                </li>
                              </ul>
                            </div>
