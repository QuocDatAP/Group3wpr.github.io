      ...
      <div class="row m-0">
        ...
        <div class="col-md-9 p-0">
          <div class="main-banner">
            <div class="banner1"> <img src="<?php echo get_theme_file_uri('images/slider/slider-image-1.jpg') ?>" alt=" ">
            ...
            <div class="banner2"> <img src="<?php echo get_theme_file_uri('images/slider/slider-image-2.jpg') ?>" alt=" ">
              <div class="banner-detail">
                <div class="row">
            ...
            <div class="banner3"> <img src="<?php echo get_theme_file_uri('images/slider/slider-image-3.jpg') ?>" alt=" ">
              <div class="banner-detail">
                <div class="banner-detail-inner"> 
        ...
        <div class="row mlr_-20">
          <div class="col-sm-6 plr-20">
            <div class="sub-banner banner-text-left"> 
              <a> 
                <img src="<?php echo get_theme_file_uri('images/banner/banner-1.jpg') ?>" alt=" ">
          ...
          <div class="col-sm-6 plr-20">
            <div class="sub-banner banner-text-right"> 
              <a> 
                <img src="<?php echo get_theme_file_uri('images/banner/banner-2.jpg') ?>" alt=" ">
                <div class="sub-banner-detail">
          ...
          <div class="row mlr_-20">
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 plr-20">
              <div class="product-item">
                ...
                <a href="product-page.html"> <img src="<?php echo get_theme_file_uri('images/products/item-1.jpg') ?>" alt=""> </a>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 plr-20">
              <div class="product-item">
                <div class="product-image"> 
                <a href="product-page.html"> <img src="<?php echo get_theme_file_uri('images/products/item-2.jpg') ?>" alt=""> </a>
                  <div class="product-detail-inner">
                    <div class="item-overlay">
                      <ul>
                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 plr-20">
              <div class="product-item">
              <div class="product-image"> 
                <a href="product-page.html"> <img src="<?php echo get_theme_file_uri('images/products/item-3.jpg') ?>" alt=""> </a>
                <div class="product-detail-inner">
                  <div class="item-overlay">
                      <ul>
                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 plr-20">
              <div class="product-item">
                <div class="product-image"> 
                <a href="product-page.html"> <img src="<?php echo get_theme_file_uri('images/products/item-4.jpg') ?>" alt=""> </a>
                  <div class="product-detail-inner">
                    <div class="item-overlay">
                      <ul>
                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 plr-20">
              ...
              <div class="sale-label"><span>Sale</span></div>
                <div class="product-image"> 
                <a href="product-page.html"> <img src="<?php echo get_theme_file_uri('images/products/item-5.jpg') ?>" alt=""> </a>
                  <div class="product-detail-inner">
                    <div class="item-overlay">
                      <ul>
                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 plr-20">
              <div class="product-item">
                <div class="product-image"> 
                <a href="product-page.html"> <img src="<?php echo get_theme_file_uri('images/products/item-6.jpg') ?>" alt=""> </a>
                  <div class="product-detail-inner">
                    <div class="item-overlay">
                      <ul>
                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 plr-20">
              ...
              <div class="sale-label"><span>Sale</span></div>
                <div class="product-image"> 
                <a href="product-page.html"> <img src="<?php echo get_theme_file_uri('images/products/item-7.jpg') ?>" alt=""> </a>
                  <div class="product-detail-inner">
                    <div class="item-overlay">
                      <ul>
                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 plr-20">
              <div class="product-item">
                <div class="product-image"> 
                <a href="product-page.html"> <img src="<?php echo get_theme_file_uri('images/products/item-8.jpg') ?>" alt=""> </a>
                  <div class="product-detail-inner">
                    <div class="item-overlay">
                      <ul>
                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
          ...
          <div class="row">
            <div class="owl-carousel pro_cat_slider">
              ...
              <div class="item">
                <div class="product-item">
                  <div class="sale-label"><span>Sale</span></div>
                  <div class="product-image"> <a href="product-page.html"> <img src="<?php echo get_theme_file_uri('images/products/item-9.jpg') ?>" alt=" "> </a>
                    <div class="product-detail-inner">
                      <div class="item-overlay">
                        <ul>
                          <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
              ...
              <div class="item">
                <div class="product-item">
                  <div class="product-image"> 
                  <a href="product-page.html"> <img src="<?php echo get_theme_file_uri('images/products/item-9.jpg') ?>" alt=" "> </a>
                    <div class="product-detail-inner">
                      <div class="item-overlay">
                        <ul>
                          <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="item">
                  <div class="product-item">
                    <div class="product-image"> 
                    <a href="product-page.html"> <img src="<?php echo get_theme_file_uri('images/products/item-10.jpg') ?>" alt=" "> </a>
                      <div class="product-detail-inner">
                        <div class="item-overlay">
                          <ul>
                            <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                  ...
                  <div class="item">
                    <div class="product-item">
                      <div class="product-image"> 
                      <a href="product-page.html"> <img src="<?php echo get_theme_file_uri('images/products/item-11.jpg') ?>" alt=" "> </a>
                        <div class="product-detail-inner">
                          <div class="item-overlay">
                            <ul>
                              <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="blog-media">                         
                        ...
                        <img src="<?php echo get_theme_file_uri('images/blog/blog-1.jpg') ?>" alt=" "> 
                        </a> 
                      </div>
                    </div>
                ...
                <div class="blog-item">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="blog-media">
                        <a href="single-blog.html" title="" class="read">
                        <img src="<?php echo get_theme_file_uri('images/blog/blog-2.jpg') ?>" alt=" "> 
                        </a> 
                      </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="blog-item">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="blog-media"> 
                        <a href="single-blog.html" title="" class="read">
                        <img src="<?php echo get_theme_file_uri('images/blog/blog-3.jpg') ?>" alt=" "> 
                        </a> 
                      </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="client-inner testimonial-block">
              <div id="client" class="owl-carousel">
                <div class="item client-detail">
                  <div class="client-img"> <img src="<?php echo get_theme_file_uri('images/testimonial/testimonial-1.jpg') ?>" alt="Xpent"> </div>
                ...
                <div class="item client-detail">
                  <div class="client-img"> <img src="<?php echo get_theme_file_uri('images/testimonial/testimonial-2.jpg"') ?> alt="Xpent"> </div>
                  <p>"Temporibus dicta soluta, distinctio voluptatum, non culpa quod vitae laudantium! Esse qui, labore ducimus."</p>
                  <h4 class="sub-title client-title">Marketing</h4>
                  <div class="date">Dec, 12 2017</div>
                </div>
                <div class="item client-detail">
                  <div class="client-img"> <img src="<?php echo get_theme_file_uri('images/testimonial/testimonial-3.jpg') ?>" alt="Xpent"> </div>
      ...
      <div class="row brand">
        <div class="col-md-12">
          <div id="brand-logo" class="owl-carousel align_center">
            <div class="item"><a href="#"><img src="<?php echo get_theme_file_uri('images/brands/brand-1.jpg') ?>" alt=" "></a></div>
            <div class="item"><a href="#"><img src="<?php echo get_theme_file_uri('images/brands/brand-2.jpg') ?>" alt=" "></a></div>
            <div class="item"><a href="#"><img src="<?php echo get_theme_file_uri('images/brands/brand-3.jpg') ?>" alt=" "></a></div>
            <div class="item"><a href="#"><img src="<?php echo get_theme_file_uri('images/brands/brand-4.jpg') ?>" alt=" "></a></div>
            <div class="item"><a href="#"><img src="<?php echo get_theme_file_uri('images/brands/brand-5.jpg') ?>" alt=" "></a></div>
            <div class="item"><a href="#"><img src="<?php echo get_theme_file_uri('images/brands/brand-6.jpg') ?>" alt=" "></a></div>
            <div class="item"><a href="#"><img src="<?php echo get_theme_file_uri('images/brands/brand-7.jpg') ?>" alt=" "></a></div>
            <div class="item"><a href="#"><img src="<?php echo get_theme_file_uri('images/brands/brand-8.jpg') ?>" alt=" "></a></div>
            <div class="item"><a href="#"><img src="<?php echo get_theme_file_uri('images/brands/brand-9.jpg') ?>" alt=" "></a></div>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-sm-4">
          <div class="widget widget_products">
            ...
            <ul class="product_list_widget">
              <li>
                <a href="#"> 
                  <img width="70" height="85" src="<?php echo get_theme_file_uri('images/products/item-small-1.jpg') ?>"> 
              ...
              <li>
                <a href="#"> 
                  <img width="70" height="85" src="<?php echo get_theme_file_uri('images/products/item-small-2.jpg') ?>"> 
                  <span class="product-title">Ecstasy Ladis Cloth</span> 
                </a> 
                <div class="price-box"> 
                  <span class="price">$30.00</span> <del class="price old-price">$100.00</del>
              ...
              <li>
                <a href="#"> 
                  <img width="70" height="85" src="<?php echo get_theme_file_uri('images/products/item-small-3.jpg') ?>"> 
                  <span class="product-title">Ecstasy Ladis Cloth</span> 
                </a> 
                <div class="price-box"> 
                  <span class="price">$30.00</span> <del class="price old-price">$100.00</del>
        ...
        <div class="col-sm-4">
          <div class="widget widget_products">
            ...
            <ul class="product_list_widget">
              <li>
                <a href="#"> 
                  <img width="70" height="85" src="<?php echo get_theme_file_uri('images/products/item-small-4.jpg') ?>"> 
                  <span class="product-title">Ecstasy Ladis Cloth</span> 
                </a> 
                <div class="price-box"> 
                  <span class="price">$30.00</span> <del class="price old-price">$100.00</del>
              ...
              <li>
                <a href="#"> 
                  <img width="70" height="85" src="<?php echo get_theme_file_uri('images/products/item-small-5.jpg') ?>"> 
                  <span class="product-title">Ecstasy Ladis Cloth</span> 
                </a> 
                <div class="price-box"> 
                  <span class="price">$30.00</span> <del class="price old-price">$100.00</del>
              ...
              <li>
                <a href="#"> 
                  <img width="70" height="85" src="<?php echo get_theme_file_uri('images/products/item-small-6.jpg') ?>"> 
                  <span class="product-title">Ecstasy Ladis Cloth</span> 
                </a> 
                <div class="price-box"> 
                  <span class="price">$30.00</span> <del class="price old-price">$100.00</del>
        ...
        <div class="col-sm-4">
          <div class="widget widget_products">
            ...
            <ul class="product_list_widget">
              <li>
                <a href="#"> 
                  <img width="70" height="85" src="<?php echo get_theme_file_uri('images/products/item-small-7.jpg') ?>"> 
                  <span class="product-title">Ecstasy Ladis Cloth</span> 
                </a> 
                <div class="price-box"> 
                  <span class="price">$30.00</span> <del class="price old-price">$100.00</del>
              ...
              <li>
                <a href="#"> 
                  <img width="70" height="85" src="<?php echo get_theme_file_uri('images/products/item-small-8.jpg') ?>"> 
                  <span class="product-title">Ecstasy Ladis Cloth</span> 
                </a> 
                <div class="price-box"> 
                  <span class="price">$30.00</span> <del class="price old-price">$100.00</del>
              ...
              <li>
                <a href="#"> 
                  <img width="70" height="85" src="<?php echo get_theme_file_uri('images/products/item-small-9.jpg') ?>"> 
                  <span class="product-title">Ecstasy Ladis Cloth</span> 
                </a> 
                <div class="price-box"> 
                  <span class="price">$30.00</span> <del class="price old-price">$100.00</del>
